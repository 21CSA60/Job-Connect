...
// import CandidateReview from "./pages/employer/CandidateReview" // Moved from recruiter to employer
...
//               {/* Redirect Recruiter Routes to Employer Routes */}
//               <Route path="/recruiter/dashboard" element={<Navigate to="/employer/dashboard" replace />} />
//               <Route
//                 path="/recruiter/review/:id"
//                 element={<Navigate to={({ params }) => `/employer/review/${params.id}`} replace />}
//               />
...
// import AllJobs from "./pages/AllJobs"
// import Login from "./pages/Login"
// import Signup from "./pages/Signup" // Import the new enhanced signup page
// import JobDetails from "./pages/JobDetails"
